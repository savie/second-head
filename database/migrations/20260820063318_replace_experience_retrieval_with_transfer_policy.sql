-- SECOND HEAD — replace owner Experience retrieval result shape to expose transfer policy.
-- Required because PostgreSQL does not allow CREATE OR REPLACE to change OUT parameter types.
