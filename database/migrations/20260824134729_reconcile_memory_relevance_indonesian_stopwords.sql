      ...
      nullif(
        regexp_replace(
          regexp_replace(
            ...
            '\\\\m(apa|adalah|anda|atau|bahwa|bagaimana|biasanya|dengan|dari|dan|dalam|di|ini|itu|juga|karena|ke|kapan|kamu|kalau|kemana|ketika|mengapa|oleh|pada|saya|sebagai|seperti|tentang|terkait|untuk|yang)\\\\M',
            ' ',
            'gi'
          ),
          '\\\\s+',
