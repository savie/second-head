...
begin
  -- Governance evaluator is the authoritative identity/authorization decision.
  ...
  -- Enforcement must independently confirm the matrix/policy decision.
  ...
  -- Isolation is a mandatory downstream boundary check; it can only reduce access.
