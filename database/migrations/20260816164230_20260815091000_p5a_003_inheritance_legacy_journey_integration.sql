...
create or replace function public.runtime_record_legacy(p_source_sh_id uuid,p_legacy_type text,p_payload jsonb default '{}'::jsonb,p_provenance jsonb default '{}'::jsonb,p_retention_until timestamptz default null)
returns uuid language plpgsql security definer set search_path = public as $$
declare v_id uuid;
begin
