...
begin
 ...
 select jsonb_build_object(
   'identity_root', jsonb_build_object(
     'sh_id',s.sh_id,'account_id',s.account_id,'sh_type',s.sh_type,'is_primary',s.is_primary,
     'canonical_name',s.canonical_name,'creator_ref',s.creator_ref,'status',s.status,'metadata',s.metadata,'version',s.version
   ),
