...
begin
  ...
  where authorization_id = p_authorization_id and status = 'APPROVED'
  for update;
  ...
  values(p_authorization_id,v_auth.source_sh_id,v_auth.target_sh_id,coalesce(p_payload,'{}'::jsonb),coalesce(p_provenance,'{}'::jsonb))
