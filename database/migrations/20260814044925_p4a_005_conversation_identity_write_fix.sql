...
BEGIN
  ...
  VALUES (v_identity.account_id, v_identity.sh_id, p_role, p_content, coalesce(p_metadata, '{}'::jsonb))
...
BEGIN
  ...
  WHERE c.account_id = v_identity.account_id AND c.sh_id = v_identity.sh_id
