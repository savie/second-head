...
class _SideMenuState extends State<SideMenu> {
  ...
  Future<void> _logout() async {
    try { await AuthSession.service.signOut(); }
    finally { if (!mounted) return; Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (_) => const LoginScreen()), (route) => false); }
  }
