...
class ConversationRuntimeBridge {
  ...
  Future<void> updateMessage({required String conversationId, required DateTime createdAt, required String role, required String oldContent, required String newContent}) =>
      _service.updateMessage(messageId: conversationId, oldContent: oldContent, newContent: newContent);

  Future<void> deleteMessage({required String conversationId, required DateTime createdAt, required String role, required String content}) =>
      _service.deleteMessage(messageId: conversationId);
