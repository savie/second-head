...
class JourneyRuntimeService {
  ...
  Future<Map<String, dynamic>> acceptKnowledge({
    required String knowledgeId,
    String expectedLifecycle = 'CANDIDATE',
    ...
    Map<String, dynamic> provenance = const {},
        ...
        'runtime_accept_knowledge',
        {
          ...
          'p_expected_lifecycle': expectedLifecycle,
          'p_operation_key': operationKey,
          'p_decision_ref': decisionRef,
          'p_validation_ref': validationRef,
          'p_provenance': provenance,
        },
      );

  Future<Map<String, dynamic>> indexKnowledge({
    required String knowledgeId,
    String expectedLifecycle = 'ACCEPTED',
    required String operationKey,
    required String indexRef,
    Map<String, dynamic> provenance = const {},
  }) => _jsonRpc(
        'runtime_index_knowledge',
        {
          ...
          'p_expected_lifecycle': expectedLifecycle,
          'p_operation_key': operationKey,
          'p_index_ref': indexRef,
          'p_provenance': provenance,
        },
      );

  Future<Map<String, dynamic>> activateKnowledge({
    required String knowledgeId,
    String expectedLifecycle = 'INDEXED',
    required String operationKey,
    required String decisionRef,
    required String confirmationRef,
    Map<String, dynamic> provenance = const {},
  }) => _jsonRpc(
        'runtime_activate_knowledge',
        {
          ...
          'p_operation_key': operationKey,
          'p_decision_ref': decisionRef,
          'p_confirmation_ref': confirmationRef,
          'p_provenance': provenance,
        },
      );
  ...
  Future<Map<String, dynamic>> updateKnowledge({
    required String knowledgeId,
    required String expectedLifecycle,
    required String operationKey,
    required String updateRef,
    required String successorContent,
    Map<String, dynamic> provenance = const {},
    Map<String, dynamic> successorProvenance = const {},
  }) => _jsonRpc(
        'runtime_update_knowledge',
        {
          ...
          'p_expected_lifecycle': expectedLifecycle,
          'p_operation_key': operationKey,
          'p_update_ref': updateRef,
          'p_provenance': provenance,
          'p_successor_content': successorContent,
          'p_successor_provenance': successorProvenance,
        },
      );

  Future<Map<String, dynamic>> deprecateKnowledge({
    required String knowledgeId,
  ...
  Future<Map<String, dynamic>> archiveKnowledge({
    required String knowledgeId,
    String expectedLifecycle = 'DEPRECATED',
    required String operationKey,
    required String decisionRef,
    required String confirmationRef,
    Map<String, dynamic> provenance = const {},
  ...
  Future<String> createRecoverySnapshot({
    required String shId,
    String? verificationMarker,
  }) async {
    final result = verificationMarker == null
        ? await backendClient.rpc(
        ...
        : await backendClient.rpc(
            ...
            params: {
              'p_sh_id': shId,
              'p_verification_marker': verificationMarker,
            },
          );
    return _uuid(result, 'Recovery snapshot creation');
  }

  Future<String> restoreRecoverySnapshot({required String snapshotId}) async {
    final result = await backendClient.rpc(
      'runtime_restore_recovery_snapshot',
      params: {'p_snapshot_id': snapshotId},
    );
    return _uuid(result, 'Recovery restore');
  }

  Future<String> materializeRegisteredClone() async {
    final result = await backendClient.rpc('runtime_materialize_registered_clone');
    return _uuid(result, 'Clone materialization');
  }
  ...
  Future<String> createClone({
    ...
    return _uuid(result, 'Clone creation');
  }

  Future<String> recordInheritance({
    ...
    return _uuid(result, 'Inheritance recording');
  }

  Future<String> executeSuccession({required String successionId}) async {
    final result = await backendClient.rpc(
      'runtime_execute_succession',
      params: {'p_succession_id': successionId},
    );
    return _uuid(result, 'Succession execution');
  }

  Future<String> recordLegacy({
    ...
    return _uuid(result, 'Legacy recording');
  }

  Future<String> endOfLife({
    required String shId,
    String? reason,
  }) async {
    final result = await backendClient.rpc(
    ...
    return _uuid(result, 'End-of-life operation');
  }
  ...
  Future<String> createKnowledgeLifecycleConfirmation({
    ...
    return _uuid(result, 'Knowledge lifecycle confirmation creation');
  }

  Future<String> confirmKnowledgeLifecycle({required String confirmationId}) async {
    final result = await backendClient.rpc(
      'runtime_confirm_knowledge_lifecycle',
      params: {'p_confirmation_id': confirmationId},
    );
    return _uuid(result, 'Knowledge lifecycle confirmation');
  }
