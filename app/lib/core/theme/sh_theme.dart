...
// Compatibility aliases used by the existing Conversation surface.
  ...
  return ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      enabledBorder: OutlineInputBorder(
        ...
        borderSide: BorderSide(color: light ? const Color(0xFFD2D9E2) : shBorder, width: 1.2),
      ),
    ...
    navigationBarTheme: NavigationBarThemeData(
      ...
      iconTheme: WidgetStateProperty.resolveWith((states) {
        if (states.contains(WidgetState.selected)) return const IconThemeData(color: shPurple, size: 22);
        return IconThemeData(color: light ? const Color(0xFF46515E) : Colors.white70, size: 22);
      }),
      labelTextStyle: WidgetStateProperty.resolveWith((states) => TextStyle(
        fontSize: 11,
        fontWeight: FontWeight.w500,
        color: states.contains(WidgetState.selected) ? shPurple : (light ? const Color(0xFF46515E) : Colors.white70),
      )),
    ),
  );
}
