    ...
    return (
      <View style={styles.loginScreen}>
        ...
        <TextInput
          ...
          placeholder="Nama lo (opsional, buat user baru)"
          placeholderTextColor="#555"
        />
        <TouchableOpacity
    ...
    >
      ...
      <View style={styles.inputArea}>
        <TextInput
          ...
          placeholder="Ketik pesan atau /image kucing lucu..."
          placeholderTextColor="#555"
          multiline
        />
...
const styles = StyleSheet.create({
  ...
  sendText: {
    fontSize: 18
      ...
      setErrorMsg('checkLogin error: ' + e.message);
      setScreen('login');
    }
  };
  ...
  if (screen === 'loading') {
    return (
      <View style={styles.centerScreen}>
        <ActivityIndicator color="#00ff88" size="large" />
        {errorMsg ? <Text style={{color:'red', marginTop:16, padding:16}}>{errorMsg}</Text> : null}
      </View>
    );
  }
...
const styles = StyleSheet.create({
  ...
  header: {
    backgroundColor: '#111', padding: 16, paddingTop: 48,
    alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#00ff88',
